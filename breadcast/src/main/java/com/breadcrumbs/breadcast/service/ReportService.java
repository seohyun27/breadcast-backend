...
public class ReportService {
    ...
    public BakeryReport addReport(Long userId, BakeryReport bakeryReport) {
        /*
        -userId와 BakeryReport 엔티티를 사용하여 제보를 데이터베이스에 저장합니다.
    ...
    /// 유저가 제보글을 직접 삭제하는 경우 ///
    public void deleteBakeryReport(Long bakeryReportId, Long userId) {
        /*
        -bakeryReportId와 userId를 사용하여 제보를 삭제합니다.
        -bakeryReportRepository.findById를 호출하여 해당 제보가 존재하는지 확인합니다.
        - 조회된 제보 엔티티의 작성자 ID가 userId와 일치하는지 확인하여 삭제 권한을 검증합니다.
