...
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (6, '레몬마들렌', 3200, '레몬아이싱이 전체적으로 입혀져 폭신하고 상큼하고 촉촉해요 인기 짱 ++', '', 2);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (7, '사각바스크치즈케이크', 6500, 'No밀가루 / 끼리크림치즈를 듬뿍 넣어 만들었어요:) 꾸덕하고 촉촉하고 부드러운 완벽한 수제 바스크치즈케이크', '', 2);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (8, '쫀득 크루키', 6500, '[크로와상 겉과 속에 쿠키반죽을 넣어 겉은 바삭 속은 쫀~득] : 깔리바우트 고급초콜릿이 듬뿍 들어가있어요 , 크루아상 안의 쿠키반죽은 촉촉해요 :)', '', 2);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (9, '에그타르트', 3300, '+인기메뉴+ 필링가득한 포르투갈식 에그타르트 / 재료값 인상으로 가격이 인상된 점 양해부탁드립니다 ㅠㅁㅠ', '', 2);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (10, '초코버터크로플', 4500, '크로플 위에 초코소스와 쿠키크럼블이 듬뿍 뿌려드려요요 :)', '', 2);
...
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (12, '프렌치토스트', 10000, '직접 구운 브리오슈를 아파레유에 30시간 이상 숙성 후 버터에 구워낸 겉바속촉 토스트', '', 3);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (13, '조각타르트/케이크', 7000, '종류에 따라 가격이 달라요!', '', 3);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (14, '밀로우크로플', 11000, '잠자는 곰돌이아이스크림이 올라갑니다. 바닐라or초코 중 선택', '', 3);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (15, '캐릭터마들렌', 6500, '레몬, 초코마들렌 구성', '', 3);
...
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (17, '101 수제 크로플', 8900, '크로플3EA + (생크림+메이플시럽+바닐라아이스크림)', '', 4);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (18, '브뤼셀 와플 + 생크림(메이플와플)', 8500, '주문즉시 바로 구워서 나가요ლ(´ڡ`ლ)', '', 4);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (19, '브뤼셀 와플 + 생크림(누텔라와플)', 8500, '주문즉시 바로 구워서 나가요ლ(´ڡ`ლ)', '', 4);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (20, '브뤼셀 와플 + 생크림(메이플/누텔라 반반 와플)', 8500, '주문즉시 바로 구워서 나가요ლ(´ڡ`ლ)', '', 4);
...
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (22, '갸또 쇼콜라', 6500, '벨기에 커버춰 초코를 넣어 만든 꾸덕하고 풍미깊은 갸또쇼콜라. 올라가는 크림이 킥입니다.', '', 5);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (23, '치즈 케이크', 6500, '원물을 듬뿍 넣어 만든 부드러운 치즈 케이크. 데코는 조금씩 달라질 수 있습니다.', '', 5);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (24, '치즈 케이크', 5000, '고급 식빵 + 신선한 과일 + 마스카포네 우유 생크림 or 요거트 생크림', '', 5);
...
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (26, '카라멜 크로칸슈', 3000, '크로칸슈와 카라멜의 환상조화', '', 6);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (27, '크로칸볼', 3000, '겉은 바삭하고 속은 부드러운 크로칸볼', '', 6);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (28, '에그타르트', 2800, '기본에 충실한 에그타르트', '', 6);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (29, '클래식스콘', 3200, '담백하고 바삭한 스콘', '', 6);
...
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (31, '순우유 망청', 8500, '바닐라시트+100%동물성생크림+망고생과+청포도생과', '', 7);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (32, '샹티 망고', 8500, '바닐라시트+100%동물성생크림+마스카포네+생과일2단샌딩및데코', '', 7);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (33, '초코 딸기', 8500, '초코시트+100%동물성생크림+과일2단샌딩및데코', '', 7);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (34, '요거트생크림', 8800, '바닐라시트+무가당요거트+100%동물성생크림+직접조린퓨레+생과일2단샌딩 및 데코', '', 7);
...
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (36, '로투스와플', 7000, '바삭달콤와플 + 로투스스프레드 + 바닐라아이스크림 + 로투스크럼블', '', 8);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (37, '생복숭아와플', 13000, '바삭와플 + 생복숭아 + 요거트아이스크림 + 100%우유휘핑크림', '', 8);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (38, '골드키위와플', 13000, '달콤한 골드키위 한가득 + 와플 + 100% 매일우유 휘핑 크림 + 요거트아이스크림', '', 8);
INSERT INTO menu (menu_id, menu_name, price, inform, menu_photo, bakery_id)
VALUES (39, '요거트와플', 9000, '바삭달콤와플 + 100% 매일우유 휘핑 크림 + 요거트아이스크림 + 메이플시럽', '', 8);
